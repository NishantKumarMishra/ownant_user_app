  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-surface border border-border text-textPrimary hover:bg-primary/5',
        outline: 'border border-border bg-surface text-textPrimary hover:bg-primary/5',
        ghost: 'text-textSecondary hover:bg-primary/5',
        danger: 'border border-danger text-danger bg-surface hover:bg-dangerLight',
